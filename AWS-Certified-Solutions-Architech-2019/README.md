...
#### Amazon Redshift
_Redshift_ is a managed data warehouse solution designed for OLAP databases. It is based on PostgreSQL and it is not port of RDS. Redshift uses the _columnar storage_.  
